...
def main():
    ...
    try:
        ...
        try:
            print("🔍 Checking for potentially conflicting packages...")
            subprocess.check_call([sys.executable, "-m", "pip", "uninstall", "-y", "socketio"], 
                                 stderr=subprocess.DEVNULL, stdout=subprocess.DEVNULL)
            print("✓ Removed potentially conflicting 'socketio' package")
        except subprocess.CalledProcessError:
            # It's fine if it's not installed
            pass
            
        # Now install the correct dependencies in the correct order
        print("🔄 Installing dependencies in the correct order...")
    ...
    if args.qr or args.qr_file:
        try:
            ...
            print("Use this URL in your Android client app to connect")
